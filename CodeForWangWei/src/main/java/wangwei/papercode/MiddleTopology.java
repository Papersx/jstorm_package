...
/**
 *测试拓扑-1：拓扑结构简单
 * 拓扑结构：DataSourceSpout--Bolt1--Bolt2--Bolt3--Bolt4
 * 拓扑功能：
...
public class MiddleTopology {
    ...
    public static class Bolt4 extends BaseRichBolt{
        ...
        @Override
        public void execute(Tuple input) {
            input.getIntegerByField("myField004");
    ...
    public static void main(String[] args) {
        //构建Topology，DataSourceSpout--Bolt1--Bolt2--Bolt3--Bolt4
...
//        cluster.submitTopology("simpleTopology", new Config(), builder.createTopology());
        ...
        //提交到集群上运行
        String topoName = MiddleTopology.class.getSimpleName();
        try {
